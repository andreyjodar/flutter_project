  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      routes: {
        ...
        Routes.companyForm: (context) => CompanyForm(existingCompany: ModalRoute.of(context)?.settings.arguments as Company?, registerCompanyUseCase: RegisterCompanyUseCase(CompanyRepositoryImpl(companyDao: FirebaseCompanyDao(FirebaseFirestore.instance), userRepository: UserRepositoryImpl(FirebaseUserDao(FirebaseFirestore.instance)))), updateCompanyUseCase: UpdateCompanyUseCase(CompanyRepositoryImpl(companyDao: FirebaseCompanyDao(FirebaseFirestore.instance), userRepository: UserRepositoryImpl(FirebaseUserDao(FirebaseFirestore.instance)))), getProducersUseCase: GetProducersUseCase(UserRepositoryImpl(FirebaseUserDao(FirebaseFirestore.instance)))),
