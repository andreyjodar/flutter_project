      ...
      child: Column(
        children: [
          ...
          DropdownButtonFormField(
            value: _productType,
            decoration: const InputDecoration(hintText: 'Tipo de Produto', border: OutlineInputBorder()),
            items: const [
              DropdownMenuItem(value: 'Verduras', child: Text('Verduras')),
              DropdownMenuItem(value: 'Hortaliças', child: Text('Hortaliças')),
          ...
          DropdownButtonFormField(
            value: _productUn,
            decoration: const InputDecoration(hintText: 'Unidade de Medida', border: OutlineInputBorder()),
            items: const [
              DropdownMenuItem(value: 'Unidade', child: Text('Unidade')),
              DropdownMenuItem(value: 'Bandeja', child: Text('Bandeja')),
              DropdownMenuItem(value: 'Quilograma', child: Text('Quilograma')),
          ...
          TextFormField(
            ...
            decoration: const InputDecoration(hintText: 'Empresa', border: OutlineInputBorder()),
            validator: (value) {
              if(value == null || value.isEmpty) {
